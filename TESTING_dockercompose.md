...
docker run --rm --net demo-saleseng-drupal_default amazeeio/dockerize dockerize -wait tcp://mariadb:3306 -timeout 1m
```
...
docker-compose exec -T cli bash -c "env" | grep LAGOON_ROUTE | grep demo-saleseng-drupal.docker.amazee.io

...
1. Checkout this project repo and confirm the path is in Docker's file sharing config - https://docs.docker.com/docker-for-mac/#file-sharing
    ...
    ```bash
    git clone https://github.com/lagoon-examples/demo-saleseng-drupal.git demo-saleseng-drupal && cd $_
    ```
...
4. Visit the new site @ `http://demo-saleseng-drupal.docker.amazee.io`
...
6. Visit the new site @ `http://demo-saleseng-drupal.lndo.site`
